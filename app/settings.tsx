    ...
    >
      ...
      <View style={styles.section}>
        ...
        <View style={[styles.row, { backgroundColor: Colors.surface, borderColor: Colors.border }]}> 
          <Text style={[styles.rowText, { color: Colors.text }]}>Photo Access</Text>
          <View style={styles.rowRight}>
            <Text style={{ color: permissionDenied ? Colors.delete : Colors.textSecondary }}>
              {permissionUndetermined ? "Unknown" : permissionDenied ? "Denied" : "Granted"}
            </Text>
            <TouchableOpacity style={[styles.rowButton, { backgroundColor: Colors.accent }]} onPress={() => refetch()}>
      ...
      <View style={styles.section}>
        ...
        <View style={[styles.row, { backgroundColor: Colors.surface, borderColor: Colors.border }]}> 
          <Text style={[styles.rowText, { color: Colors.text }]}>Reset App State</Text>
          <TouchableOpacity style={[styles.rowButton, { backgroundColor: Colors.delete }]} onPress={() => {
            // reset via store
